...
## Features
- **Memory-Safe (Anti-OOM):** Uses Node.js Stream Pipelines to handle massive font downloads securely on mobile OS constraints like Termux.
...
## Credits
Built with love by [Razael](https://github.com/Razael-Fox) and [Gemini](https://gemini.google.com/).
